...
export const RESEARCH_AREA_ASSIGNMENTS: Record<string, ResearchArea[]> = {
  ...
  /* ── Peptide bioregulators and slice 3.9A additions ─────────────────── */
  'catalog:thymalin': ['immune-inflammation', 'longevity-aging'],
  'catalog:thymogen': ['immune-inflammation'],
  'catalog:vilon': ['immune-inflammation', 'longevity-aging'],
  'catalog:cortagen': ['cognitive', 'longevity-aging'],
  'catalog:cartalax': ['recovery', 'longevity-aging'],
  'catalog:vesugen': ['longevity-aging'],
  'catalog:bronchogen': ['immune-inflammation'],
  'catalog:livagen': ['longevity-aging'],
  'catalog:pancragen': ['weight-metabolic', 'longevity-aging'],
  'catalog:prostamax': ['endocrine'],
  'catalog:testagen': ['endocrine'],
  'catalog:ovagen': ['longevity-aging'],
  'catalog:chonluten': ['immune-inflammation'],
  'catalog:peg-mgf': ['growth-hormone', 'recovery'],
  'catalog:foxo4-dri': ['longevity-aging'],
  'catalog:aicar': ['mitochondrial', 'weight-metabolic'],
  'catalog:p21': ['cognitive'],
  'catalog:pe-22-28': ['cognitive'],
  'catalog:setmelanotide': ['weight-metabolic', 'endocrine'],
  'catalog:eloralintide': ['weight-metabolic'],
  'catalog:orforglipron': ['weight-metabolic', 'endocrine'],
  'catalog:blend-tesamorelin-ipamorelin': ['growth-hormone'],
  'catalog:blend-mitochondrial-stack': ['mitochondrial', 'weight-metabolic'],
  'catalog:blend-thymic': ['immune-inflammation'],
};
