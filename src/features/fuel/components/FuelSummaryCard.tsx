  ...
  return (
    <Card>
      <View style={styles.headRow}>
        {/* The label sits under the ring rather than inside it: "Calories
            consumed" is wider than the ring's inner diameter, and shrinking
            the approved wording to fit would be the wrong trade. */}
        <View style={styles.ringColumn}>
          ...
          <Text
            style={[styles.ringLabel, { color: surfaces.textTertiary }]}
            numberOfLines={1}
            adjustsFontSizeToFit
