...
Supporting flows (built, reached from Dashboard/quick actions and from the [[Fuel]] screen's compact modules rather than the dock): [[Water]] and [[Peptides]]. Both became real, persisted features in **Sprint 3 — Water + Peptides**, the current sprint — feature-complete and in final audit / closeout ([[Roadmap]]). Their long-term navigation placement is still an [[Open Questions|open question]] (#4).
