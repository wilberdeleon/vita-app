...
- **Design System sequencing.** This is one of Vita's most externally visible surfaces. The [[Design Bible|Light + Dark semantic token system]] shipped app-wide 2026-08-16, so the blocker is now narrower: a widget must match both themes and follow the Home visual language, and iOS widgets resolve appearance independently of the in-app theme picker
