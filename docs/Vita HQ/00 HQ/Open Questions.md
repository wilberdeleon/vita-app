...
16. **Who owns the hydration goal — [[Water]] or [[Settings]]?** The founder direction for Water requires a **user-defined** daily goal with a unit (cups/oz/mL/L) that persists until changed. Settings is the natural long-term home for that preference, but Settings is **Sprint 7 — still after** Water + Peptides, which the 2026-08-21 reorder moved forward to **Sprint 3**. That makes this question live sooner, not later. Does Water own the goal initially and Settings absorb it later, or does Sprint 3 build a minimal preference surface that Sprint 7 then adopts? *Owner: founders/Claude, at Sprint 3 planning.*
