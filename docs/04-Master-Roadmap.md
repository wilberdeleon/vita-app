...
**Status: 🟡 IN PROGRESS** — opened 2026-09-02, branch `sprint-5-identity-interaction`. **5.1–5.5 are founder-approved on device and locked** (5.4 and 5.5 together on 2026-09-07, which locks Peptides). **5.6B — Fuel Home Identity is locked** (founder device review, 2026-09-09), together with 5.6A, 5.6A.1 and subpasses 5.6B.1–5.6B.4. **5.6C — Fuel Food Discovery is locked** (founder device review, 2026-09-09). Slices 5.7–5.10 are planned, not authorized.
...
**What remains in 5.6:** **5.6D — scanner internals, Food Detail, Manual Entry**.
