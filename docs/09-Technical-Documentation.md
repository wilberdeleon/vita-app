...
## Known mocks (as of Sprint 2, slice 2.1)
...
| Area | State |
|---|---|
| Food entries, daily totals, meal grouping, targets | **Real.** Persisted via `src/lib/nutrition`. |
...
| Add Manually | Uncontrolled inputs; nothing is saved. Slice 2.2. |
...
| Home nutrition | Still its own fixture until slice 2.5 wires it to the shared engine. |
